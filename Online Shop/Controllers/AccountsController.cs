...
namespace Online_Shop.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterModel model)
        {
            ...
            if (!result.Succeeded)
                return StatusCode(StatusCodes.Status500InternalServerError, new Response { Status = "Error", Message = ValidConst.ErrorUserCreationFailed });

            return Ok(new Response { Status = "Success", Message = ValidConst.UserCreation });
        }
